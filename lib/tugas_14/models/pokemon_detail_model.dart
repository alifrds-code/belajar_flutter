...
class ModelPokemon {
  ...
  factory ModelPokemon.fromJson(Map<String, dynamic> json) => ModelPokemon(
    ...
    pastStats: json["past_stats"] == null
        ? []
        : List<PastStat>.from(
  ...
  Map<String, dynamic> toJson() => {
    ...
    "past_stats": pastStats == null
        ? []
        : List<dynamic>.from(pastStats!.map((x) => x.toJson())),
...
class PastStat {
  ...
  PastStat({this.generation, this.stats});
...
class GenerationIx {
  ...
  factory GenerationIx.fromJson(Map<String, dynamic> json) => GenerationIx(
    scarletViolet: json["scarlet-violet"] == null
        ? null
        : DreamWorld.fromJson(json["scarlet-violet"]),
  );

  Map<String, dynamic> toJson() => {"scarlet-violet": scarletViolet?.toJson()};
}
...
class GenerationViii {
  ...
  GenerationViii({this.brilliantDiamondShiningPearl, this.icons});

  factory GenerationViii.fromJson(Map<String, dynamic> json) => GenerationViii(
    brilliantDiamondShiningPearl:
        json["brilliant-diamond-shining-pearl"] == null
        ? null
        : DreamWorld.fromJson(json["brilliant-diamond-shining-pearl"]),
    icons: json["icons"] == null ? null : DreamWorld.fromJson(json["icons"]),
  );
